...
export default function WalletAddressLoading() {
  return (
    <main className="min-h-screen px-6 py-6 md:px-10">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        <header className="border-b pb-5">
          ...
          <div className="mt-4 h-9 w-full max-w-md animate-pulse rounded-md bg-secondary" />
          <div className="mt-3 h-5 w-full max-w-2xl animate-pulse rounded-md bg-secondary" />
        </header>
              ...
              <Card key={item}>
                ...
                <CardContent>
                  <div className="grid gap-3">
                    {[0, 1, 2].map((row) => (
                      <div key={row} className="h-16 animate-pulse rounded-md bg-secondary" />
                    ))}
                  </div>
                </CardContent>
              </Card>
